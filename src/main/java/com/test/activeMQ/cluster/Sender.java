package com.test.activeMQ.cluster;
	...
	public static void main(String[] args) {
		try {
			...
			ConnectionFactory connectionFactory = new ActiveMQConnectionFactory(
					...
					"failover:(tcp://192.168.1.240:51511,tcp://192.168.1.241:51512,tcp://192.168.1.242:51513)?Randomize=false");
			...
			for(int i = 0 ; i < 500000 ; i ++){
				...
				// 第四个参数 优先级
				// 第五个参数 消息的过期时间
				producer.send(destination, msg, DeliveryMode.NON_PERSISTENT, 0 , 60*1000L);
